...
## Example Code
Example code for the Arduino IDE and the Wemos board and shield can be found and download from their Github repository. https://github.com/wemos/D1_mini_Examples
